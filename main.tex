...
\author{%
Erik \firstauthorlastname,$^1$ Xian Chang,$^2$ Jordan Eizenga,$^2$ Glenn Hickey,$^2$ Jean Monlong,$^2$ Adam Novak,$^2$ Robin Rounthwaite,$^2$ Benedict Paten,$^2$ Jonas Sibbesen,$^2$ and Jouni Sir\'{e}n$^2$
\affil{$^1$Genomics Institute, University of California Santa Cruz, Santa Cruz, CA, USA, 95064; email: erik.garrison@ucsc.edu}
