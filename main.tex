...
%Abstract
\begin{abstract}
  %Low-cost whole genome assemblies
  %allow us to build pangenome reference models that represent the total genomic information in a species, clade, or collection of related genomes.
%  A pangenome represents the total genomic information in a species, clade, or collection of related genomes.
  ...
  %Despite conceptual benefits to using them as a reference system, pangenomes have proved difficult to 
  %The problem of representing and utilizing the 
  %Many recently-developed bioinformatic methods use pangenome reference systems.
  ...
  %However,
  %We survey these methods and review recent results demonstrating their utility.
  %Among other quantitative and qualitative benefits,
  The additional information provided to these methods by the pangenome allows them to achieve superior performance on a variety of bioinformatic tasks.
  %Pangenomic read mappears align sequences without bias towards the reference genome.
  %Pangenomic genotypers achieve highly accurate results %are among the mest accurate and efficient.
  %Pangenome graphs represent collections of genomes and their mutual alignment.
  %Graphical pangenomes can work harmoniously with multiple linear reference systems, allowing them to unify and build upon standard reference genomes, rather than replacing them.
  Pangenome graphs stand to become a ubiquitous tool in genomics. %tool to respond to the continual increase of genome data scale and scope.
  Although they are often considered a possible replacement for linear reference genomes, current methods demonstrate that their their ability to harmoniously relate between multiple genomes makes compatibility with existing reference systems striaghtforward to maintain.
  %form the basis for generalizations of many genomic analyses to collections of related genomes.
  %but, because they harmoniously link existing reference systems 
\end{abstract}
