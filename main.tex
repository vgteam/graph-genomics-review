...
\begin{abstract}
  ...
  Although they are often considered a possible replacement for linear reference genomes, current methods demonstrate that their ability to harmoniously relate between multiple genomes makes compatibility with existing reference systems straightforward to maintain.
\end{abstract}
