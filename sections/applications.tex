...
The simplest approach to using variation data in mapping involves creating a personalized diploid genome and using it as the reference for a standard linear mapping method \cite{Turro2011-op,Rozowsky_2011,Bray_2016,Raghupathy2018-sd}.
This approach has been shown to reduce reference bias and improve estimation of ASE relative to standard reference approaches, but it generally requires phased haplotypes for the individuals under study.
Variant-aware mappers like ASElux \cite{Miao2018-ps}, iMapSplice \cite{Liu_2018} and GSNAP \cite{Wu2010-hv,Castel2015-ef} remove this necessity.
Indeed, all three have all shown to reduce reference bias by using known SNVs during mapping, resulting in better estimates of ASE compared to conventional methods \cite{Miao2018-ps}.
