...
Indeed, it have been shown that reference bias can be reduced by using variant-aware mappers, such as GSNAP, iMapSplice and HISAT2 \cite{Castel2015-ef,Liu_2018}. 
