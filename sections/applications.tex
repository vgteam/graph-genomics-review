...
Here, we consider developments in variant calling and genotyping, haplotype inference, functional genomics, and metagenomics.
...
Variant-aware mappers like \textsc{GSNAP} \cite{Wu2010-hv}, \textsc{iMapSplice} \cite{Liu_2018} and \textsc{HISAT2} \cite{Kim_2019} remove this necessity, and have been shown to reduce reference bias at known SNVs during mapping \cite{Castel2015-ef,Liu_2018}.
