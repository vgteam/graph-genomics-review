...
It is infeasible to apply such computationally demanding methods to the data scales obtained with modern high-throughput sequencing. % \cite{schuster2008next}. %, and furthermore, doing so would require increased sequencing costs.
