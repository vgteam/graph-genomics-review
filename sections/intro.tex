...
Pangenomics thus stands in contrast to standard genomics by emphasizing the total sum of available genomic information over a particular consensus model of the genome.
...
\todo{JAS: This last sentence could easily be removed without losing the broader points of the paragraph.}
...
\todo{JAS: Use same citations for ASE reference bias as transcriptomics section: Degner 2009, Castel 2015}
...
\todo{JAS: Note that the HISAT2 paper only shows results for DNA and does not mention RNA-seq bias. There are other methods that are variant aware (not graph-based) that shows reduction in bias: Liu 2018, Miao 2018}
...
\todo{JAS: This last paragraph feels a bit misplaced. Maybe move the stuff about precision medicine to discussion?}
