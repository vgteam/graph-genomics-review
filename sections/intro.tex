...
%In these studies, less attention is been given to small variation between genomes, or to the representation of full genomes and their precise sequence relationships.

%These units are easily observable with short read sequencing technologies.
%These approaches often do not consider small variation, or to the representation of full genomes and their precise sequence relationships.
%The pangenome is typically presented as a collection of unique gene sequences or contigs.
%Less importance is given to precise alignments between these contigs, haplotypes, and allelic variation within them.
...
%This expedient and conservative approach has its merits,
%Using a single reference genome will become untenable with the development of
...
%the genomics community still lacks standard, efficient approaches that generalize current genome inference methods to work on pangenomes.
