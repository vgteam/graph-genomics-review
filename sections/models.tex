...
GenomeMapper \cite{Schneeberger_2009}, the first graph-based read aligner, was limited to such graphs.
Its indexing was also relatively simple.
GenomeMapper uses a simple hash-based $k$-mer index, with $k \le 13$ to limit memory usage.
