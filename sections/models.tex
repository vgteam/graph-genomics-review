...
The VG tool offers multiple graph construction algorithms, including the de novo assembly algorithm MSGA (Multiple Sequence to Graph Aligner) \cite{Garrison_2018,Novak_2017a}. 
...
Seqwish, another de novo construction algorithm in the VG ecosystem, was developed to address the weaknesses of MSGA\footnote{\url{https://github.com/ekg/seqwish}}.
