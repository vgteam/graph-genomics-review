...
Some methods, like the journaled string tree \cite{Rahn_2014}, never construct the graph explicitly, instead using the variant and reference to support dynamic queries of the pangenome.\todo{EG: there is another method produced by UCL/kings people recently that should be mentioned here.}
