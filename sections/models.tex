...
Determining which sequences provide a compact represenation of a pangenome is non-trivial.
Many software systems support this process.
...
gramtools \cite{Maciuca_2016}

\subsection{Refining sequences}

These tools use variation aware pangenome indexes to infer a better haploid sequence model for a given genome, then do variant calling against that.
gramtools \cite{Maciuca_2016}
PanVC \cite{Valenzuela_2018}
