...
%supporting relation to other reference systems and rendering  making the model equivalent to a collection of sequences and their mutual alignment. %, and allowing relation of data in the model to other graphs and reference genomes.
...
%The problem of selecting and relating sequences in this collection has driven the development of
Several approaches support the construction, annotation, and interrogation of these pangenomic sequence collections. %selected so as to provide a compact and complete representation of the pangenome.
...
%The graphs it generates contain all kinds of variation represented in the input alignments, including both small variants like SNPs and indels and large structural variation and precisely represent the full set of input sequences.
...
%and contain all kinds of variation represented in the input alignments.
%The input sequences are projected into paths embedded in the resulting variation graph.
%The output represents all kinds of variation, both small and large, described by the input alignments.
...
Index data structures for pangenome graphs support efficient random access to elements and features of the graph. %, which is essential for their use.
