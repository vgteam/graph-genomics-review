...
It takes either a prebuilt DAG or generated one from a multiple alignment of sequences.
...
Bowe et~al.\ \cite{Bowe_2012} used techniques similar to GCSA for representing de Bruijn graphs.
