...
However, certain downstream applications also benefit from incorporating information on genomic variation in transcriptomics.
...
This allows for existing algorithms in VG to also be used for variant-aware mapping of RNA-seq data. 
