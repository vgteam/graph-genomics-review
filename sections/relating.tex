...
V-MAP's fast clustering heuristics allow it to align high-error long reads more efficiently than VG, but there has yet to be a published comparison to GraphAligner \cite{Vaddadi_2019}.
