...
Once a significant barrier to pangenomics research, the field now provides a array of well-performing, increasingly efficient read mapping tools for variation graphs. 
These tools represent a menu of performance tradeoffs that researchers can choose among depending on their study's requirements.


Invariably, variation graphs mappers make use of the seed-extend paradigm that has also been successful for conventional linear references.
