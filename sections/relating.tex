...
\todo{JAS: I did not know what force-directed graph layouts was before googling it just now. Maybe a single sentence or citation describing it here or in the table.}
...
\todo{JAS: In the interest of manuscript length I think the above paragraph could maybe be shorten or removed.}
...
The increasing prominence of genome graph methods has been predicated on fundamental algorithmic research in graph alignment, and it has also spurred further research.

The trend in the graph alignment research is toward greater generality and faster run time. 
First, the algorithms apply to increasingly general classes of graphs. 
...
\todo{JAS: In table 2 only VG is described as accurate. Is that true and what is meant by accurate? I think it could be misunderstood.}
