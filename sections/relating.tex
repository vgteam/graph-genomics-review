...
GraphAligner & De Bruijn graph, variation graph (including complex) & Long read & Fast \\ \hline
GenomeMapper & \multirow[c]{4}{=}{Variation graph (acyclic)} & \multirow[c]{3}{=}{NGS} & No longer maintained \\ \cline{1-1} \cline{4-4}
Graph Genome Aligner &  &  &  \\ \cline{1-1} \cline{4-4}
HISAT2 &  &  & Fast \\ \cline{1-1} \cline{3-4}
V-MAP &  & Long read, NGS & \\ \hline
VG & Variation graph (including complex) & NGS & Accurate, high memory usage \\ \hline
