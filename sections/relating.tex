...
Several methods have been published that specifically focus on reducing mapping bias around SNVs for RNA-seq data. 
...
GSNAP is still competitive contemporary mapping methods with regards to mapping accuracy, but it is generally much slower \cite{Castel2015-ef}.
...
HISAT2's mapping algorithm for transcriptomic sequencing is the same as for genomic DNA (See above).
