...
Visualization tools can be roughly separated into two target applications based on their input data: genome assembly graphs contain nodes and edges whereas variation graphs contain nodes, edges, and paths.
